...
namespace TallinnaRakenduslikCollegeTARpe24_StenUesson.Data
{
    public class DbInitializer
    {
        public static void Initializer(SchoolContext context)
        {
            ...
            {
                new Instructor { FirstName="DONKEY", LastName="Dragon",HireDate=DateTime.Now, gender=Instructor.Gender.Male},
                new Instructor { FirstName = "Shrek", LastName = "Ö G E R", HireDate = DateTime.Now, Age = 50},
                new Instructor { FirstName = "George", LastName = "Dragon", HireDate = DateTime.Now, gender=Instructor.Gender.Male },
